...
function checkPassword() {
    ...
    let correctPassword = "adamusportfolio"; // Ustaw swoje hasło

    if (password === correctPassword) {
        //window.open("https://drive.google.com/file/d/1lFW5_wA0wuiwC0jt24zneKDA9212A8zU/view?usp=sharing", "_blank");
		window.open("https://www.adamusdaniel.com/subpages/portfolio_gallery.html","_self");
	} else {
...
function checkPassword() {
    ...
    let correctPassword = "1234"; // Ustaw swoje hasło

    if (enteredPassword === correctPassword) {
        window.location.href = "https://drive.google.com/file/d/1lFW5_wA0wuiwC0jt24zneKDA9212A8zU/view?usp=sharing";
    } else {
